...
# Load the processed datafiles (and their corresponding metadata) from the extract_data() function in target_class_lib.sh into a list of Pandas dataframes and, for those not having unique 'name' columns, make them unique
